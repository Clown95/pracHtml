    ...
    var lift = {
        ...
        c: function (f) {
            ...
            for (var i = 0; i <= f_num - 1; i++) {
                ...
                c_a.appendTo(c_li);
                c_li.mouseenter(function () {
                    $(this).find('.f-name').show(40);
                }).mouseleave(function () {
                    $(this).find('.f-name').hide(40);
                })
...
$(function () {
    ...
    if ($('#flash_sale').length != 0) {
        ...
        $('#countdown').countdown({
            alwaysExpire: true,
            layout: '<span class="clr-4c4c4c fs-22 mlr-3">{dnn}</span>天<span class="clr-4c4c4c fs-22 mlr-3">{hnn}</span>时<span class="clr-4c4c4c fs-22 mlr-3">{mnn}</span>分<span class="clr-4c4c4c fs-22 mlr-3">{snn}</span>秒',
            until: endDate,
            format: 'DHMS',
            timezone: +8
        });
...
function show_dialog(t, msg, style, has_close, work_place) {
    ...
    if (!style) {
        ...
        var defaultstyle = {
            left: (style['read'] == 1) ? style['left'] : L,
            top: !style['top'] ? H : style['top'],
            width: !style['width'] ? '500px' : style['width']
        };
